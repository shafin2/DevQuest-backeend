...
<head>
  ...
  <title>Reset Your Password - DevQuest</title>
</head>
    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
          ...
          <tr>
            <td style="padding: 50px 40px;">
              ...
              <p style="margin: 0 0 24px; color: #4B5563; font-size: 16px; line-height: 1.6;">
                We received a request to reset your password for your DevQuest account.
              </p>
          ...
          <tr>
            <td style="padding: 30px 40px; background-color: #FEF2F2; border-top: 1px solid #FEE2E2; border-left: 4px solid #E11D3A;">
